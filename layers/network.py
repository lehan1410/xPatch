...
class Network(nn.Module):
    def __init__(self, seq_len, pred_len, c_in, period_len, d_model):
        ...
        self.seasonal_out = nn.Linear(self.d_model, self.period_len)  # Đầu ra là period_len
    ...
    def forward(self, s, t):
        ...
        # Kiểm tra chia hết period_len
        assert I % self.period_len == 0, "seq_len phải chia hết period_len"
        assert self.pred_len % self.period_len == 0, "pred_len phải chia hết period_len"
